...
public class KillWhileBlindedTrigger extends SimpleCriterionTrigger<KillWhileBlindedTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.KILL_WHILE_BLINDED.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
