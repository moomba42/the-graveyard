package com.moomba.graveyard.advancements;
...
public class KilledByBoneDaggerTrigger extends SimpleCriterionTrigger<KilledByBoneDaggerTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.KILLED_BY_BONE_DAGGER.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
