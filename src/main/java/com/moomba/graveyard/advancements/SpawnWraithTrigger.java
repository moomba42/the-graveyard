...
public class SpawnWraithTrigger extends SimpleCriterionTrigger<SpawnWraithTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.SPAWN_WRAITH.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
