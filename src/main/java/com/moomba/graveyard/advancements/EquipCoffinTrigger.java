...
public class EquipCoffinTrigger extends SimpleCriterionTrigger<EquipCoffinTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.EQUIP_COFFIN.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
