...
public class DimLightTrigger extends SimpleCriterionTrigger<DimLightTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.DIM_LIGHT.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
