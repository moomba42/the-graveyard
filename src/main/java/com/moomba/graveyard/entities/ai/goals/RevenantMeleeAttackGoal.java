...
public class RevenantMeleeAttackGoal extends Goal {
    protected final RevenantEntity mob;
    ...
    private final int DAMAGE_START_IN_ANIM = 7;
    private int animationTicker = 9;
    private boolean canFinishAttack = false;

    public RevenantMeleeAttackGoal(RevenantEntity mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
        this.speed = speed;
    ...
    protected void attack(LivingEntity target, double squaredDistance) {
        ...
        if (squaredDistance <= d && this.cooldown <= 0 && this.mob.getReanimateAnimTimer() <= 0) {
