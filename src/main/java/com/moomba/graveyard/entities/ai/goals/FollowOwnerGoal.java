package com.moomba.graveyard.entities.ai.goals;

import com.moomba.graveyard.entities.GraveyardMinionEntity;
...
public class FollowOwnerGoal extends Goal {
    ...
    private final GraveyardMinionEntity tamable;
    ...
    public FollowOwnerGoal(GraveyardMinionEntity p_25294_, double p_25295_, float p_25296_, float p_25297_, boolean p_25298_) {
    ...
    public void tick() {
        ...
        if (--this.timeToRecalcPath <= 0) {
            ...
            if (!this.tamable.isLeashed() && !this.tamable.isPassenger()) {
                if (this.tamable.distanceToSqr(this.owner) >= 288.0D) {
